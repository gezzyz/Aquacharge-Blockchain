...
export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/organizations/peerOrganizations/orgevowner.example.com/tlsca/tlsca.orgevowner.example.com-cert.pem
export CORE_PEER_MSPCONFIGPATH=${PWD}/organizations/peerOrganizations/orgevowner.example.com/users/Admin@orgevowner.example.com/msp
